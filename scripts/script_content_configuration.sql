...
'MSVALIDCONNECT','TRY_CONNECTION','ALDO ALEJANDRO SANCHEZ FELIX','ALDO ALEJANDRO SANCHEZ FELIX');

--INSERT PARA GENERAR TOKEN
insert into cat_loginless ("type", ip) values ('MSVALIDCONNECT',md5('127.0.0.1'));